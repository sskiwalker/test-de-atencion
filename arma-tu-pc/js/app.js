...
(function (D, M) {
  ...
  function estadoAHash() {
    ...
    if (S.nivel !== 2) partes.push('nivel=' + S.nivel);
  ...
  function aplicarHash() {
    ...
    S.cfg.fg = o.fg === '1';
    if (['1', '2', '3'].indexOf(o.nivel) >= 0) S.nivel = Number(o.nivel);
    if (o.j) {
  ...
  function filaFps(r) {
    ...
    const tr = el('tr');
    const j = r.juego;
    tr.appendChild(el('td', {}, '<span class="j-nombre">' + esc(j.n) + '</span><br><span class="j-meta motor">' +
